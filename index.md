...
3-15 허기는 게임 내 시간이 흐르면 지속적으로 감소한다.  
3-16 피로도는 게임 내 스킬을 사용했을때 감소한다.  
3-17 피로도, 허기 게이지가 0일때 캐릭터는 쓰러짐 상태로 바뀐다.  
3-18 피로도 게이지가 20아래로 떨어지면 피곤함 상태로 바뀐다.  
3-19 허기짐 게이지가 20아래로 떨어지면 배고픔 상태로 바뀐다.  
