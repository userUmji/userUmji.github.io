...
2-15 구매 버튼 또는 판매 버튼을 누르면 구매할 개수를 입력하는 창이 표시된다.  
2-16 창에서 개수를 입력하고 구매하기 버튼을 누르면 소지금액이 감소하고 인벤토리에 구매한 아이템이 들어간다.  
2-17 창에서 개수를 입력하고 판매하기 버튼을 누르면 소지금액이 증가하고 인벤토리에 판매한 아이템이 삭제된다.  
